...
const RankTable2022 = () => {
    ...
    return (
        <div className="sm:container mx-auto mt-8 font-brown-bold">
            ...
            <div className="flex md:justify-center justify-start items-center xl:mr-[600px] lg:mr-[400px] md:mr-[300px]">
            ...
            {activeTable === 'PRO' ? (
                <div>
                    <div className="md:flex justify-center xl:items-center">
                        <div className="relative sm:mb-[30px] mb-[20px] flex items-center justify-center mobile-sm:mt-12 mobile-md:mt-12 mobile-lg:mt-12 md:mt-0 xl:mr-[400px] lg:mr-[170px] md:mr-[10px] flex text-black">
                        ...
                        <p className="text-center md:text-left mb-[20px] md:mb-0  text-[#232323] lg:text-[18px]  text-[15px]">Accurate After: MCB Tour Championship Mauritius 2022</p>
                    </div>
                <div className="overflow-x-auto">
                <table className="xl:w-[1200px] lg:w-[950px] md:w-[700px] sm:w-[600px] w-[500px]  mx-auto bg-white border border-gray-200">
                    ...
                    {filteredPlayers.length > 10 && (
                        <div className="text-center mt-4">
                            <button
                                className="ml-4 bg-[#522367] font-brown-bold text-[18px] mt-[50px] uppercase text-white px-6 py-4"
                ...
                <div>
                    <div className="md:flex justify-center xl:items-center">
                        ...
                        <p className="text-center md:text-left mb-[20px] md:mb-0 text-[#232323] lg:text-[18px]  text-[15px] xl:mr-[40px]  ">Accurate After: Staysure PGA Seniors Championship 2022 <br/>- Celebrity</p>
                    </div>
                <div className="overflow-x-auto">
                <table className="xl:w-[1200px] lg:w-[950px] md:w-[700px] sm:w-[600px] w-[500px]  mx-auto bg-white border border-gray-200">
                    <thead className="bg-[#522367] text-white text-[13px]">
                ...
                <div>
                    <div className="md:flex justify-center xl:items-center">
                        <div className="relative sm:mb-[30px] mb-[20px] flex items-center justify-center mobile-sm:mt-12 mobile-md:mt-12 mobile-lg:mt-12 md:mt-0 xl:mr-[305px] lg:mr-[75px] md:mr-[10px] flex text-black">
                        ...
                        <p className="text-center md:text-left mb-[20px] text-[#232323] lg:text-[18px]  text-[15px]">Accurate After: MCB Tour Championship Mauritius 2022 - Alliance</p>
                    </div>
                <div className="overflow-x-auto">
                <table className="xl:w-[1200px] lg:w-[950px] md:w-[700px] sm:w-[600px] w-[500px]  mx-auto bg-white border border-gray-200">
                    <thead className="bg-[#522367] text-white text-[13px]">
