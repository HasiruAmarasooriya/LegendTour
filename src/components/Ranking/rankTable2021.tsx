...
const RankTable2021 = () => {
    ...
    const filteredPlayersCELEB = playersData.filter(player =>
        player.name.toLowerCase().includes(searchInput.toLowerCase())
    );
            ...
            {activeTable === 'PRO' ? (
                <div>
                    <div className="md:flex justify-center xl:items-center">
                        ...
                        <p className="text-center md:text-left mb-[20px] md:mb-0 text-[#232323] lg:text-[18px]  text-[15px]">Accurate After: MCB Tour Championship Mauritius 2021</p>
                    </div>
                <div className="overflow-x-auto">
                    ...
                    <div className="md:flex justify-center xl:items-center">
                        ...
                        <div className="flex items-center justify-center flex-shrink-0 mb-[20px] md:mb-[45px] lg:mb-0">
                            <Image
                                src={WCS}
                                alt="WcsLogo"
                                className="w-[250px] h-[30px] xl:mr-[70px] xl:ml-[70px] lg:mr-[30px] md:mr-[10px] md:ml-[10px]  text-gray-400"
                            />
                        </div>

                        <p className="text-center md:text-left mb-[20px] md:mb-0 text-[#232323] lg:text-[18px]  text-[15px] xl:mr-[40px]  ">Accurate After: MCB Tour Championship - Celebrity</p>
                    </div>
                <div className="overflow-x-auto">
                <table className="xl:w-[1200px] lg:w-[950px] md:w-[700px] sm:w-[600px] w-[500px]  mx-auto bg-white border border-gray-200">
                    <thead className="bg-[#522367] text-white text-[13px]">
