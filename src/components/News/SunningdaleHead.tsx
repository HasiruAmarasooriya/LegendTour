...
import Header from '../../../public/img/news/JK-media-centre.jpg';
import Paragraph from '../News/newsParagraphSection'
        ...
        <div className='font-brown-regular overflow-hidden bg-[#f2f2f2] '>
            <div className="relative w-full">
                ...
                <div className="absolute bottom-0 left-0 flex items-center justify-center text-white text-[32px] md:text-[38px] lg:text-[60px] font-brown-bold font-bold w-full ">
                    <h1 className='lg:mb-[10.5rem] mb-[2.5rem]  xl:max-w-[800px] lg:max-w-[800px] xl:mr-[400px]  lg:mr-[130px] md:mr-[30px] ml-[20px] leading-none text-left'>Haeggman goes wire-to-wire in India</h1>
                </div>
            </div>
            <div className="relative bottom-0 left-0 p-4    mt-[-60px] ">
                ...
                <div className="flex items-center justify-center ">
                    <h1 className='relative xl:max-w-[650px] lg:max-w-[550px] lg:mr-[370px] xl:mr-[540px] md:ml-[10px] md:max-w-[730px] sm:max-w-[550px]  text-left flex items-center  leading-none font-brown-bold  justify-center  text-[24px] lg:text-[40px] mt-[80px] lg:mt-0 mb-[2.5rem] text-[#522367]'>
                        Joakim Haeggman claimed his second Legends Tour victory at the inaugural HSBC India Legends Championship hosted by Jeev Milkha Singh.               </h1>
                </div>

                <h3 className="lg:text-[26px] text-[18px] xl:mr-[970px] lg:mr-[720px] md:mr-[570px] flex items-center justify-center  text-[#232323] font-brown-regular mb-[3.5rem]">1 September 2024</h3>
