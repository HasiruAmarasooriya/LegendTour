...
const LegendCarousel: React.FC<LegendCarouselProps> = ({ legends }) => {
    ...
    return (
        <div className="relative">
            {/* Cards Container */}
            <div className="flex space-x-[20px] bg-white xl:items-center items-start xl:justify-center justify-start overflow-x-auto">
...
const LegendsPage = () => {
    return (
        <div className="bg-white ">
        <div className="container mx-auto lg:pt-[180px] pt-[70px] lg:mt-[180px] mt-[70px] lg:mb-[80px] mb-[30px] ">

            <h2 className="text-[30px] lg:text-[60px] text-[#522367] font-brown-bold text-start xl:text-center xl:mr-[700px] mb-8">Legends Profiles</h2>
            <p className="text-start xl:text-center lg:text-[26px] text-[18px] text-[#232323] xl:mr-[260px] font-brown-light mb-12">
                From Major Winners to Ryder Cup Captains, connect with your golfing heroes
            </p>
